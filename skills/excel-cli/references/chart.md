...
```
Best for: Simple data in slide ranges
...
```
Best for: PowerPoint Tables with structured references
...
- `set-style`: Apply PowerPoint chart styles (1-48)
