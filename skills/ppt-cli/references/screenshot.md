...
- **`screenshot`**: Capture slide content as PNG images
...
2. **Capture relevant area**: Use `capture` with a specific range rather than `capture-sheet` when you only need part of the slide
