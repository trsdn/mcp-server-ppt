...
```
1. Structure data → PowerPoint Tables (never plain ranges)
...
## Step 1: Structure Data as PowerPoint Tables

**Always use PowerPoint Tables for tabular data:**
...
**Always use US format codes** — PowerPoint translates automatically to the user's locale.
...
```
A1:D10    → Data table (formatted as PowerPoint Table)
...
- [ ] Data in PowerPoint Tables (not plain ranges)
