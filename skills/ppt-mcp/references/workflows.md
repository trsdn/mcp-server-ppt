# PowerPoint MCP Server - Key Constraints

These are the critical constraints and workarounds specific to PowerPoint automation via COM.

## PowerPoint Power Pivot Limitations

PowerPoint's Power Pivot has key limitations compared to Power BI/SSAS:
...
2. powerquery create/update (store validated query in presentation)
3. powerquery refresh/load-to (load data to destination)
```
Skipping step 1 causes broken queries in presentation and cryptic COM errors.
