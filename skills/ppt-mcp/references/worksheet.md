...
```
action: copy-to-file
sourceFile: C:\Reports\Q1.pptx
sheetName: Summary
targetFile: C:\Reports\Annual.pptx
...
```
action: move-to-file
sourceFile: C:\Drafts\Data.pptx
sheetName: FinalData
targetFile: C:\Published\Report.pptx
...
For same-file operations (copy within same presentation, rename, delete, tab colors), use session-based actions with `sessionId`.
